...
\begin{itemize*}
\item Developed the installer for the relational database product, Sybase IQ.  Added new features using Java, fixed reported bugs and maintained build scripts in a UNIX environment.
